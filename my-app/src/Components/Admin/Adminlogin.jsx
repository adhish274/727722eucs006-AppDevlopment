...
import adminloginimage from 'C:/Users/flyto/Advanced_App_Development/Advanced_App_Development/my-app/src/Images/adminlogin.avif';
...
const Adminlogin = () => {
    ...
    return (
        <div className='outerbg' style={{ fontFamily: '"Quicksand", "Helvetica Neue", Arial, sans-serif'}}>
        <div>
            <div className='home-header'>
                <div className='header-title'>
                    <img src={hallspace} className='web-logo' alt="HallSpace Logo" onClick={() => navigate('/')}/>
                    <p className='header-title-text'>HallSpace</p>
                </div>
            </div>
            <br></br>
