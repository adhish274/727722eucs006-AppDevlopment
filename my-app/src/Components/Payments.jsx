...
const Payments = () => {
    ...
    return (
        ...
        >
            <Card sx={{ width: 400, padding: 4, backgroundColor: '#b1d4eb' }}>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', backgroundColor: '#f0f0f0', borderRadius: '5px', padding: '10px', marginTop: '5px' }}>
                                <PersonOutlineIcon sx={{ color: 'black', marginRight: 1 }} />
                                <TextField
                                    fullWidth
                        ...
                        <Grid item xs={12}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', backgroundColor: '#f0f0f0', borderRadius: '5px', padding: '10px', marginTop: '5px' }}>
                                <CreditCardIcon sx={{ color: 'black', marginRight: 1 }} />
                                <TextField
                                    fullWidth
                        ...
                        <Grid item xs={6}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', backgroundColor: '#f0f0f0', borderRadius: '5px', padding: '10px', marginTop: '5px' }}>
                                <CalendarTodayOutlinedIcon sx={{ color: 'black', marginRight: 1 }} />
                                <TextField
                                    fullWidth
                                    placeholder="MM/YYYY"
                                    variant="standard"
                        ...
                        <Grid item xs={6}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', backgroundColor: '#e5e9ee', borderRadius: '5px', padding: '10px', marginTop: '5px' }}>
                                <LockOutlinedIcon sx={{ color: 'black', marginRight: 1 }} />
                                <TextField
                                    fullWidth
                                    placeholder="••••••••••"
                                    variant="standard"
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogActions>
                    <Button onClick={() => navigate('/')} sx={{ margin: '0 auto', display: 'block' }}>
                        OK
                    </Button>
                </DialogActions>
            </Dialog>
